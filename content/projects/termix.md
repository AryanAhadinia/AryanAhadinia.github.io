...
A dozens of technologies have been used in this project such as Django, Django Rest Framework, NodeJS, ExpressJS, ReactJS, MongoDB, PostgreSQL, Redis, Nginx, and so on.

###### Android Version

Termix also has a Android version which is written in Java and has additional features such as alarming and notification.

<video controls="" width="50%" muted="" loop="" autoplay="" style="align: center; margin: auto; display: block;">
